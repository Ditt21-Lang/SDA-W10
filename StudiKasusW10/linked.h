...
typedef struct tElmtTree *BinTree; 
typedef BinTree infotype_list;
...
address_list SearchList (List L, infotype_list X);
/* Mencari apakah ada elemen list dengan Info(P) = X */
/* Jika ada, mengirimkan address elemen tsb. */
/* Jika tidak ada, mengirimkan Nil */

boolean FSearch (List L, address_list P);
/* Mencari apakah ada elemen list yang beralamat P */
/* Mengirimkan true jika ada, false jika tidak ada */

address_list SearchPrec (List L, infotype_list X);
...
void DelP (List * L, infotype_list X);
/* IS : L sembarang */
